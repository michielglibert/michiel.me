...
const Content: React.FC = () => {
  return (
    <VStack spacing="6" fontSize="lg" align="flex-start">
      <Text align="left">
        ...
        knowledge and skills in the field. My main drive in life is to make a
        meaningful impact, whether that be through the projects I work on or the
        people I help.
      </Text>
